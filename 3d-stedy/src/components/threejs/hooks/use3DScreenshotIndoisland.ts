...
export const use3DScreenshotIndoisland = (
  ...
  const takeScreenshot = (canvas: HTMLCanvasElement): Promise<string> => {
    return new Promise<string>((resolve) => {
      ...
      const offsetX = (canvasWidthOriginal - canvasWidthNew) / 3;
  ...
  return { fullScreenIndo, handleScreenshotIndo };
};
